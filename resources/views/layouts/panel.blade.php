...
<html>
  <head>
    ...
    {!! Html::style('http://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.5/css/materialize.min.css', array(), env("SECURE_LOADING")) !!}
    {!! Html::style('http://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.1/animate.min.css"/>', array(), env("SECURE_LOADING")) !!}
  ...
  <body>
    ...
    @yield('content')
    {!! Html::script("http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.4/jquery.min.js", [], env("SECURE_LOADING")) !!}
    {!! Html::script("http://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.5/js/materialize.min.js", [], env("SECURE_LOADING")) !!}
    <script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyDHDx5pEAwyWW_OZgBEKVowirfLkVemQSM" async defer></script>
